...
for (f in 2007:2021) {
  ...
  data <- all_dat %>% dplyr::select("Agent","Lat","Longt", "Date", "Wind" ) %>% 
    spread(Date, Wind) # convert to wide data
...
wind_all <- merge(nztm_coords,merged_data, by = c("location","lon","lat"))
...
wind_all_1 <- wind_all[1:1000,]
write.xlsx(wind_all_1, "wind_all_1.xlsx", sheetName = "wind_all", rowNames = FALSE)

wind_all_2 <- wind_all[1001:2000,]
write.xlsx(wind_all_2, "wind_all_2.xlsx", sheetName = "wind_all", rowNames = FALSE)

wind_all_3 <- wind_all[2001:3000,]
write.xlsx(wind_all_3, "wind_all_3.xlsx", sheetName = "wind_all", rowNames = FALSE)

wind_all_4 <- wind_all[3001:4000,]
write.xlsx(wind_all_4, "wind_all_4.xlsx", sheetName = "wind_all", rowNames = FALSE)

wind_all_5 <- wind_all[4001:5000,]
write.xlsx(wind_all_5, "wind_all_5.xlsx", sheetName = "wind_all", rowNames = FALSE)

wind_all_6 <- wind_all[5001:6000,]
write.xlsx(wind_all_6, "wind_all_6.xlsx", sheetName = "wind_all", rowNames = FALSE)

wind_all_7 <- wind_all[6001:7000,]
write.xlsx(wind_all_7, "wind_all_7.xlsx", sheetName = "wind_all", rowNames = FALSE)

wind_all_8 <- wind_all[7001:8000,]
write.xlsx(wind_all_8, "wind_all_8.xlsx", sheetName = "wind_all", rowNames = FALSE)

wind_all_9 <- wind_all[8001:9000,]
write.xlsx(wind_all_9, "wind_all_9.xlsx", sheetName = "wind_all", rowNames = FALSE)

wind_all_10 <- wind_all[9001:10000,]
write.xlsx(wind_all_10, "wind_all_10.xlsx", sheetName = "wind_all", rowNames = FALSE)

wind_all_11 <- wind_all[10001:11000,]
write.xlsx(wind_all_11, "wind_all_11.xlsx", sheetName = "wind_all", rowNames = FALSE)

wind_all_12 <- wind_all[11001:11491,]
write.xlsx(wind_all_12, "wind_all_12.xlsx", sheetName = "wind_all", rowNames = FALSE)
