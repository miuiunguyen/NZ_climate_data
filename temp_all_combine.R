...
for (f in 2007:2021) {
  ...
  all_dat$ave_temp <- (all_dat$TMax + all_dat$Tmin)/2
  ...
  data <- all_dat %>% dplyr::select("Agent","Lat","Longt", "Date", "TMax" ) %>% 
    spread(Date, TMax) # convert to wide data
...
tmax_all <- merge(nztm_coords,merged_data, by = c("location","lon","lat"))
...
tmax_all_1 <- tmax_all[1:1000,]
write.xlsx(tmax_all_1, "tmax_all_1.xlsx", sheetName = "precip_all", rowNames = FALSE)

tmax_all_2 <- tmax_all[1001:2000,]
write.xlsx(tmax_all_2, "tmax_all_2.xlsx", sheetName = "precip_all", rowNames = FALSE)

tmax_all_3 <- tmax_all[2001:3000,]
write.xlsx(tmax_all_3, "tmax_all_3.xlsx", sheetName = "precip_all", rowNames = FALSE)

tmax_all_4 <- tmax_all[3001:4000,]
write.xlsx(tmax_all_4, "tmax_all_4.xlsx", sheetName = "precip_all", rowNames = FALSE)

tmax_all_5 <- tmax_all[4001:5000,]
write.xlsx(tmax_all_5, "tmax_all_5.xlsx", sheetName = "precip_all", rowNames = FALSE)

tmax_all_6 <- tmax_all[5001:6000,]
write.xlsx(tmax_all_6, "tmax_all_6.xlsx", sheetName = "precip_all", rowNames = FALSE)

tmax_all_7 <- tmax_all[6001:7000,]
write.xlsx(tmax_all_7, "tmax_all_7.xlsx", sheetName = "precip_all", rowNames = FALSE)

tmax_all_8 <- tmax_all[7001:8000,]
write.xlsx(tmax_all_8, "tmax_all_8.xlsx", sheetName = "precip_all", rowNames = FALSE)

tmax_all_9 <- tmax_all[8001:9000,]
write.xlsx(tmax_all_9, "tmax_all_9.xlsx", sheetName = "precip_all", rowNames = FALSE)

tmax_all_10 <- tmax_all[9001:10000,]
write.xlsx(tmax_all_10, "tmax_all_10.xlsx", sheetName = "precip_all", rowNames = FALSE)

tmax_all_11 <- tmax_all[10001:11000,]
write.xlsx(tmax_all_11, "tmax_all_11.xlsx", sheetName = "precip_all", rowNames = FALSE)

tmax_all_12 <- tmax_all[11001:11491,]
write.xlsx(tmax_all_12, "tmax_all_12.xlsx", sheetName = "precip_all", rowNames = FALSE)
...
for (f in 2007:2021) {
  ...
  ### Since the file is too large, we choose only rain variables for our project
  data <- all_dat %>% dplyr::select("Agent","Lat","Longt", "Date", "Tmin" ) %>% 
    spread(Date, Tmin) # convert to wide data
  assign(paste("data_",f,sep=""), data.frame(data))
}
...
# Merge the data frames on the "location" column
tmin_all <- merge(nztm_coords,merged_data, by = c("location","lon","lat"))
...
tmin_all_1 <- tmin_all[1:1000,]
write.xlsx(tmin_all_1, "tmin_all_1.xlsx", sheetName = "precip_all", rowNames = FALSE)

tmin_all_2 <- tmin_all[1001:2000,]
write.xlsx(tmin_all_2, "tmin_all_2.xlsx", sheetName = "precip_all", rowNames = FALSE)

tmin_all_3 <- tmin_all[2001:3000,]
write.xlsx(tmin_all_3, "tmin_all_3.xlsx", sheetName = "precip_all", rowNames = FALSE)

tmin_all_4 <- tmin_all[3001:4000,]
write.xlsx(tmin_all_4, "tmin_all_4.xlsx", sheetName = "precip_all", rowNames = FALSE)

tmin_all_5 <- tmin_all[4001:5000,]
write.xlsx(tmin_all_5, "tmin_all_5.xlsx", sheetName = "precip_all", rowNames = FALSE)

tmin_all_6 <- tmin_all[5001:6000,]
write.xlsx(tmin_all_6, "tmin_all_6.xlsx", sheetName = "precip_all", rowNames = FALSE)

tmin_all_7 <- tmin_all[6001:7000,]
write.xlsx(tmin_all_7, "tmin_all_7.xlsx", sheetName = "precip_all", rowNames = FALSE)

tmin_all_8 <- tmin_all[7001:8000,]
write.xlsx(tmin_all_8, "tmin_all_8.xlsx", sheetName = "precip_all", rowNames = FALSE)

tmin_all_9 <- tmin_all[8001:9000,]
write.xlsx(tmin_all_9, "tmin_all_9.xlsx", sheetName = "precip_all", rowNames = FALSE)

tmin_all_10 <- tmin_all[9001:10000,]
write.xlsx(tmin_all_10, "tmin_all_10.xlsx", sheetName = "precip_all", rowNames = FALSE)

tmin_all_11 <- tmin_all[10001:11000,]
write.xlsx(tmin_all_11, "tmin_all_11.xlsx", sheetName = "precip_all", rowNames = FALSE)

tmin_all_12 <- tmin_all[11001:11491,]
write.xlsx(tmin_all_12, "tmin_all_12.xlsx", sheetName = "precip_all", rowNames = FALSE)